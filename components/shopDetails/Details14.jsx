...
import Slider1ZoomOuterColorRectangle from "./sliders/Slider1ZoomOuterColorRectangle";
export default function Details14() {
  const [currentColor, setCurrentColor] = useState(colorOptions3[0]);
  const [currentSize, setCurrentSize] = useState(sizeOptions[0]);
  const [quantity, setQuantity] = useState(1);
  const handleColor = (color) => {
    const updatedColor = colorOptions3.filter(
            ...
            <div className="col-md-6">
              <div className="tf-product-media-wrap sticky-top">
                <div className="thumbs-slider">
                  <Slider1ZoomOuterColorRectangle

...
import { Heart, MapPin, Users, Briefcase, DollarSign, Bookmark, ThumbsUp, Timer } from "lucide-react";
            ...
            <div className="p-2">
                ...
                <div className="flex space-y-2 text-sm text-gray-700">
                    ...
                    <div className="mt-4 flex flex-col justify-between items-center">
                        <button className="bg-red-500 text-white px-2 py-2 rounded-md hover:bg-red-600 transition text-xs">
                            Send Interest
                        </button>
                        <div>
                            {tab === "likes" &&
                                <p className="flex items-center pt-2 text-xs"><Timer /> {profile.dated}</p>
                            }
                            {tab === "mylikes" &&
                                <p className="flex items-center pt-2 text-xs"><Timer /> {profile.dated}</p>
                            }
                ...
                {tab === "request" &&
                    <div className="flex justify-between items-center pt-3">
                        <button className="bg-transparent border-2 border-red-500 text-red-500 px-2 py-2 rounded-3xl text-xs hover:bg-transparent transition">
                            Reject
                        </button>
                        <button className="bg-green-600 text-white px-2 py-2 rounded-3xl hover:bg-transparent transition text-xs">
                            Accept
                        </button>
                    </div>}
            </div>

                ...
                <div className="row wed-foot-link wed-foot-link-1 flex flex-wrap justify-between py-4">
                    ...
                    <div className="w-full md:w-1/3 fot-soc">
                        ...
                        <ul className="flex space-x-4">
                            <li><a href="#!"><img src="images/social/1.png" alt="FaceBook" loading="lazy" className="w-8 h-8" /></a></li>
                            <li><a href="#!"><img src="images/social/2.png" alt="Instagram" loading="lazy" className="w-8 h-8" /></a></li>
                            <li><a href="#!"><img src="images/social/3.png" alt="YouTube" loading="lazy" className="w-8 h-8" /></a></li>
                            <li><a href="#!"><img src="images/social/5.png" alt="LinkedIn" loading="lazy" className="w-8 h-8" /></a></li>
                        </ul>
                    </div>
                </div>
